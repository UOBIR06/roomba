...
class RoomIPA(object):
    def __init__(self):
        ...
        try:
            ...
            rospy.logerr(
                "Problem getting a map. Check that you have a map_server running: rosrun map_server map_server <mapname> ")
            sys.exit(1)
        ...
        self.send_goal_to_segemantation(ocuccupancy_map)
    ...
    def send_goal_to_segemantation(self, msg: OccupancyGrid) -> MapSegmentationResult:
        # if not img_path:
        #     img_path = os.path.join(util.HOME_ROOT, 'data/sim_data/meeting.png')
